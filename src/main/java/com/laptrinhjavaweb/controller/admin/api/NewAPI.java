...
/*
 * Thêm bài viết dùng doPost
 * Xóa bài viết dùng doDelete
 * Cập nhật bài viết dùng doPut
 * request là nhận về 
 * response là trả về
 * */
...
public class NewAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		NewModel newModel = HttpUtil.of(request.getReader()).toModel(NewModel.class); // convert từ json sang newModel
